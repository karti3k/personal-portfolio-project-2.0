    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            className={`w-1/3 h-14 ${selected === 'Graphic Design' ? (isDarkMode ? 'drop-shadow-2xl rounded-3xl dark:bg-custom-very-light-black bg-custom-very-light-black border-2 dark:border-custom-blue-green border-custom-blue-green dark:text-custom-blue-green text-custom-blue-green' : 'drop-shadow-2xl border-2 rounded-3xl bg-custom-blue-40 border-white') : (isDarkMode ? 'dark:text-custom-blue-green text-custom-blue-green rounded-r-none rounded-l-none border-y-2 dark:bg-custom-light-black bg-custom-light-black dark:border-custom-blue-green border-custom-blue-green' : 'border-y-2 rounded-r-none rounded-l-none bg-custom-blue border-white')}`}
